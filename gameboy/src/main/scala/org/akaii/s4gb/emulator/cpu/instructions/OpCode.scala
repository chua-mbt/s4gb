...
enum OpCode(val pattern: UByte, val mask: UByte = 0xFF.toUByte) {
  ...
  case RET_COND extends OpCode(0xC0.toUByte, excludeBits43) // 110CC000
  case RET extends OpCode(0xC9.toUByte) // 11001001
  case RETI extends OpCode(0xD9.toUByte) // 11011001
  case JP_COND_IMM16 extends OpCode(0xC2.toUByte, excludeBits43) // 110CC010
  case JP_IMM16 extends OpCode(0xC3.toUByte) // 11000011
  case JP_HL extends OpCode(0xE9.toUByte) // 11101001
  case CALL_COND_IMM16 extends OpCode(0xC4.toUByte, excludeBits43) // 110CC100
  case CALL_IMM16 extends OpCode(0xCD.toUByte) // 11001101
  case RST_TGT3 extends OpCode(0xC7.toUByte, excludeBits543) // 11TTT111
  ...
  case LDH_MEM_C_A extends OpCode(0xE2.toUByte) // 11100010
  case LDH_MEM_IMM8_A extends OpCode(0xE0.toUByte) // 11100000
  case LD_MEM_IMM16_A extends OpCode(0xEA.toUByte) // 11101010
  case LDH_A_MEM_C extends OpCode(0xF2.toUByte) // 11110010
  case LDH_A_MEM_IMM8 extends OpCode(0xF0.toUByte) // 11110000
  case LD_A_MEM_IMM16 extends OpCode(0xFA.toUByte) // 11111010
